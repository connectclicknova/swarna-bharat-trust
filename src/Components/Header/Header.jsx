        ...
        <div className="offcanvas offcanvas-end" tabIndex="-1" id="megaMenuModal" aria-labelledby="offcanvasRightLabel">
            ...
            <div className="offcanvas-body">
                ...
                <div className="mega-menu-contact">
                    <h6 className="mega-menu-contact-title">Contact Information</h6>
                    <p className="mega-menu-contact-text">Call: +1 (555) 123-4567</p>
                    <a href="mailto:info@swaranbharattrust.org" className="mega-menu-contact-btn">
                        Send an Email
                ...
                {/* Social Media */}
                <div className="mega-menu-social">
                    <h6 className="mega-menu-social-title">Follow us on</h6>
                    <div className="mega-menu-social-icons">
                ...
                <div className="mega-menu-footer">
                    <p>© 2025 Swarna Bharat Trust. All rights reserved.</p>
                </div>
            </div>
        </div>
    </div>
